...
function base_post_comments_feed_link() {
    return;
}

add_filter('post_comments_feed_link', 'base_post_comments_feed_link');
...
add_action( 'wp_enqueue_scripts', 'base_enqueue_scripts' );
...
function base_register_nav_menus() {
    register_nav_menus([
        'header' => 'Header',
        'footer' => 'Footer',
    ]);
...
add_action( 'after_setup_theme', 'base_register_nav_menus', 0 );
...
function base_mce_buttons_2( $buttons ) {
...
add_filter('mce_buttons_2', 'base_mce_buttons_2');
...
function base_tiny_mce_before_init( $settings ) {
    $style_formats = [
        // [
        //     'title'    => '',
        //     'selector' => '',
...
add_filter('tiny_mce_before_init', 'base_tiny_mce_before_init');
